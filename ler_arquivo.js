...
//	return lerArquivo('teste2.txt').then(function(contents){
//		console.log(contents);
//			return lerArquivo('teste3.txt').then(function(contents){
//				console.log(contents);	
//				return lerArquivo('teste4.txt').then(function(contents){
//					console.log(contents);	
//				})
//			})
//		})
